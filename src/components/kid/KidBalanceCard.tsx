...
interface KidBalanceCardProps {
  balance: number;
  coins: number;
  currency?: string;
}

const KidBalanceCard = ({ balance, coins, currency = "QAR" }: KidBalanceCardProps) => {
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-right">
            <p className="text-xs text-primary-foreground/60">SIRFA KIDS</p>
        ...
        <div className="flex justify-between items-end">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium">{coins} Coins</p>
            </div>
          </div>
